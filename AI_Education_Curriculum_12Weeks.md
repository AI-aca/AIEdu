...
*   **🎯 [1단계 최종 실습과제]: 안티그래비티 2.0 설치 및 빈 템플릿 구동 확인**
    *   *실습 미션*: 안티그래비티 2.0 에디터를 성공적으로 설치하고 실행한 후, 새 빈 프로젝트를 생성하십시오. 에디터 우측의 내장 프리뷰 창에 기본 흰색 화면(또는 빈 템플릿)이 정상 구동되는 것을 확인하고, 좌측 챗 창에 `"안녕 안티그래비티"`라고 한글로 입력하여 AI 에이전트가 환영 메시지로 올바르게 응답하는 첫 구동 테스트를 완수하십시오.
