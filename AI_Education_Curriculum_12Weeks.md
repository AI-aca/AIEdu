...
*   **🎯 [실습 1 완료] 안티그래비티 내장 프리뷰 1줄 명함**: 안티그래비티 내장 프리뷰 창에 내 학원 이름, 학원 전화번호가 출력되는 첫 웹 명함 화면 빌드. *(깃허브/배포 없음)*
...
*   **🎯 [실습 2 완료] 3단 랜딩 페이지**: AI 도구별 스타일 복제 기법을 벤치마킹하여, 학원 정보 캡처 이미지를 안티그래비티 챗 창에 등록하고 이를 모방한 3단 구조 랜딩 페이지를 최종 빌드합니다.
