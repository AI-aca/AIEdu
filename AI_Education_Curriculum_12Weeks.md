...
*   **권장 시청 영상**: [AI로 나만의 앱 만들기 (라이브 222회) | 오빠두엑셀](https://www.youtube.com/watch?v=BvruBvJkZNY)
*   **영상 실제 내용**: 구글 스프레드시트를 데이터베이스로 삼고 구글 드라이브 클라우드 환경에서 웹앱에 데이터를 기록할 수 있도록 설계하는 기본 데이터 송수신 메커니즘을 시연합니다.
*   **주차 학습 내용**: 구글 시트에 학생 이름, 연락처 등의 데이터 열(Column)을 기획하고 연동 데이터 구조를 파악합니다. *(실습 없음)*

#### 9회차: 안티그래비티 생성 GAS 이식 및 구글 웹앱 배포 학습
*   **권장 시청 영상**: [AI로 나만의 앱 만들기 (라이브 222회) | 오빠두엑셀](https://www.youtube.com/watch?v=BvruBvJkZNY)
*   **영상 실제 내용**: 구글 시트 앱스 스크립트(Google Apps Script) 에디터에서 웹 앱 새 배포 메뉴를 클릭하여 24시간 언제 어디서나 접속 가능한 무료 모바일 고유 URL 도메인을 런칭하는 절차를 보여줍니다.
*   **주차 학습 내용**: 안티그래비티가 구글 시트 연동용으로 작성한 GAS 코드를 시트 스크립트 에디터에 이식하고 권한 승인을 완료하는 법을 익힙니다. *(실습 없음)*

#### 10회차: API 통신 구조 학습 및 Gemini API 획득
*   **권장 시청 영상**: [API가 뭔가요? 가장 쉽게 이해시켜드림 | 얄팍한 코딩사전](https://www.youtube.com/watch?v=fB3MB8TXNXM)
*   **영상 실제 내용**: API와 API Key가 서로 다른 프로그램이나 AI 서버(Gemini 등)와 데이터를 안전하게 주고받는 메신저 역할을 한다는 핵심 개념을 비유로 설명합니다.
...
*   **권장 시청 영상**: [제대로 파는 Git & GitHub | 얄팍한 코딩사전](https://www.youtube.com/watch?v=1I3hMwQU6GU)
